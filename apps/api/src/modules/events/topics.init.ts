...
const TOPIC_SPECS: TopicSpec[] = [
  ...
  { topic: ERP_TOPICS.CASH_VOUCHER_NEEDED_KEPT_CHANGE, numPartitions: 3, replicationFactor: 1 },
  ...
  { topic: ERP_TOPICS.GOODS_ISSUE_POSTED, numPartitions: 3, replicationFactor: 1 },
  { topic: ERP_TOPICS.SALES_ORDER_SENT, numPartitions: 3, replicationFactor: 1 },
