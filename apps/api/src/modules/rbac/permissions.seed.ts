...
export const PERMISSION_SEEDS: PermissionSeed[] = [
  ...
  { key: 'inventory.temporary-transfer.read', description: 'View temporary stock transfers', module: 'inventory' },
  { key: 'inventory.temporary-transfer.create', description: 'Create temporary stock transfers (post on creation)', module: 'inventory' },
  { key: 'inventory.temporary-transfer.return', description: 'Return items from temporary location back to source', module: 'inventory' },
  { key: 'inventory.temporary-transfer.cancel', description: 'Cancel temporary stock transfers (only when nothing has been returned)', module: 'inventory' },
