...
import { UpdateCashFundReportTemplateCommand } from './update-cash-fund-report-template.command';

@CommandHandler(UpdateCashFundReportTemplateCommand)
export class UpdateCashFundReportTemplateHandler
  implements ICommandHandler<UpdateCashFundReportTemplateCommand>
{
  constructor(
  ...
  async execute({
    ...
    dto,
    actor,
  }: UpdateCashFundReportTemplateCommand): Promise<InvoiceReportTemplateView> {
