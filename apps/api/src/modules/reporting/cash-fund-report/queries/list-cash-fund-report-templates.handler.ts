...
import { ListCashFundReportTemplatesQuery } from './list-cash-fund-report-templates.query';

@QueryHandler(ListCashFundReportTemplatesQuery)
export class ListCashFundReportTemplatesHandler
  implements IQueryHandler<ListCashFundReportTemplatesQuery>
{
  constructor(
  ...
  async execute({
    ...
    reportType,
    scope,
  }: ListCashFundReportTemplatesQuery): Promise<InvoiceReportTemplateView[]> {
