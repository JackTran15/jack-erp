...
import { CreateProfitReportTemplateCommand } from './create-profit-report-template.command';

@CommandHandler(CreateProfitReportTemplateCommand)
export class CreateProfitReportTemplateHandler
  implements ICommandHandler<CreateProfitReportTemplateCommand>
{
  constructor(
  ...
  async execute({
    dto,
    actor,
  }: CreateProfitReportTemplateCommand): Promise<InvoiceReportTemplateView> {
