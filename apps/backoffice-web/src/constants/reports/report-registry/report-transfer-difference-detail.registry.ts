 ...
 *
 * Cột giống L2 trừ "Kho": phiếu chưa ai nhận thì kho đích chưa có nghĩa.
 * Cột "Tham chiếu" rỗng ở mọi dòng — đó là nội dung của dialog, không phải lỗi.
 */
let order = 0;
const col = (
  column: string,
...
export const chain_tableRegistryReportTransferDifferenceDetail = tableConfig;
export const single_filterRegistryReportTransferDifferenceDetail = [];
export const chain_filterRegistryReportTransferDifferenceDetail = [];
