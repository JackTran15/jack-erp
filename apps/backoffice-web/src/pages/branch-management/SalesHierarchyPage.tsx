...
const styles: Record<string, React.CSSProperties> = {
  ...
  placeholder: { color: "hsl(var(--muted-foreground))", fontSize: 14 },
  loading: { color: "hsl(var(--muted-foreground))", fontSize: 14 },
  ...
  empty: { color: "hsl(var(--muted-foreground))", fontSize: 14, marginTop: 0 },
  btnPrimary: {
    padding: "8px 16px",
