...
export function ConditionTypeRadioGroup({
  form,
  onChange,
  showGiftMultiplier = false,
}: Props) {
  // Rời "Yêu cầu số lượng cụ thể" -> xóa hàng hóa đã thêm (các option khác không
      ...
      {showGiftMultiplier ? (
        ...
        >
          <input
            ...
            onChange={(e) => onChange({ giftMultiplyByTotal: e.target.checked })}
          />
