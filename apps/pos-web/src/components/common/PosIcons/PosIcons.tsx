...
export function StoreIcon(props: IconProps) {
  return (
    <svg {...base(props)}>
      ...
      <path d="M2 7h20" />
      <path d="M22 7v2a2 2 0 0 1-2 2 2.7 2.7 0 0 1-1.59-.63.7.7 0 0 0-.82 0A2.7 2.7 0 0 1 16 11a2.7 2.7 0 0 1-1.59-.63.7.7 0 0 0-.82 0A2.7 2.7 0 0 1 12 11a2.7 2.7 0 0 1-1.59-.63.7.7 0 0 0-.82 0A2.7 2.7 0 0 1 8 11a2.7 2.7 0 0 1-1.59-.63.7.7 0 0 0-.82 0A2.7 2.7 0 0 1 4 11a2 2 0 0 1-2-2V7" />
    </svg>
  );
}
