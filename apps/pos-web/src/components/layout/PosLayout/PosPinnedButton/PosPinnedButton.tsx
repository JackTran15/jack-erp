...
import type { PosMenuItem } from "@erp/pos/components/layout/PosLayout/PosLayout";

export interface PosPinnedButtonProps {
  item: PosMenuItem;
  active?: boolean;
  onClick?: () => void;
}
 ...
 * 44px topbar.
 */
export function PosPinnedButton({
  item,
  active,
  onClick,
}: PosPinnedButtonProps) {
