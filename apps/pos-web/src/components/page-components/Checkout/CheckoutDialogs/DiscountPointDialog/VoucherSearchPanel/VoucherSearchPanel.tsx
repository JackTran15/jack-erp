...
import { VoucherEmptyState } from "@erp/pos/components/page-components/Checkout/CheckoutDialogs/DiscountPointDialog/VoucherSearchPanel/VoucherEmptyState/VoucherEmptyState";
