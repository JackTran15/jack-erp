import { InfoSectionGroup, type InfoRow } from "@erp/pos/components/page-components/Checkout/CheckoutRightPane/PaymentSummaryPanel/CustomerDetailDialog/InfoTab/InfoSectionGroup/InfoSectionGroup";
