...
import { StatsSection } from "@erp/pos/components/page-components/Checkout/CheckoutRightPane/PaymentSummaryPanel/CustomerDetailDialog/OverviewTab/CustomerStatsPanel/StatsSection/StatsSection";
