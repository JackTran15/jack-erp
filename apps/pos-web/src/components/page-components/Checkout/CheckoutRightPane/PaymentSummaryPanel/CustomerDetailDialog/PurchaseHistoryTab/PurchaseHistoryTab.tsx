...
import { StatusBadge } from "@erp/pos/components/page-components/Checkout/CheckoutRightPane/PaymentSummaryPanel/CustomerDetailDialog/PurchaseHistoryTab/StatusBadge/StatusBadge";
