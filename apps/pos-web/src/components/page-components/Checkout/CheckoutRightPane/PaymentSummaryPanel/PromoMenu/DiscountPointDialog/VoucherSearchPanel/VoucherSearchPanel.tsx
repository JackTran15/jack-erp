...
import { VoucherEmptyState } from "@erp/pos/components/page-components/Checkout/CheckoutRightPane/PaymentSummaryPanel/PromoMenu/DiscountPointDialog/VoucherSearchPanel/VoucherEmptyState/VoucherEmptyState";
