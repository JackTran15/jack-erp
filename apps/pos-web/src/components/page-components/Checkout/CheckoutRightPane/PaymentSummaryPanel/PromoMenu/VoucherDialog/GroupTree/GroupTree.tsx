...
import { GroupNode } from "@erp/pos/components/page-components/Checkout/CheckoutRightPane/PaymentSummaryPanel/PromoMenu/VoucherDialog/GroupTree/GroupNode/GroupNode";
