...
import { PromotionTable } from "@erp/pos/components/page-components/Checkout/CheckoutRightPane/PaymentSummaryPanel/PromotionSelectionModal/PromotionTable/PromotionTable";
import type {
  PromotionItem,
