...
import { PromotionRow } from "@erp/pos/components/page-components/Checkout/CheckoutRightPane/PaymentSummaryPanel/PromotionSelectionModal/PromotionTable/PromotionRow/PromotionRow";
