import { InfoSectionGroup, type InfoRow } from "@erp/pos/components/page-components/Checkout/Dialog/CustomerDetailDialog/InfoTab/InfoSectionGroup/InfoSectionGroup";
