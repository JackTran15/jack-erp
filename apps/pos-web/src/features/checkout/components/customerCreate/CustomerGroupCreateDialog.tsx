...
import { useCreateCustomerGroup } from "@erp/pos/hooks/useCustomerGroups";
import { type CustomerGroupRow } from "@erp/pos/lib/customerApi";
import { useDialogReset } from "../../hooks/useDialogReset";
import { userFacingError } from "./customerFormUtils";
...
export function CustomerGroupCreateDialog({
  ...
  return (
    <AppDialog open={open} onClose={onClose} width={520}>
      <AppDialog.Header title="Thêm nhóm khách hàng" />
      <AppDialog.Body>
        <form
          id={formId}
