...
import { qtyFormatter } from "../../lib/checkoutUtils";
import { ProhibitedGlyphIcon } from "@erp/pos/components/icons/Icon";
...
export function OversellCheckoutConfirmDialog({
  ...
  const columns = useMemo<ReadonlyArray<DataTableColumn<CartLine>>>(
    () => [
      {
        key: "name",
        title: "Tên hàng hóa",
  ...
  return (
    <AppDialog open={open} onClose={onClose} width={960}>
      <AppDialog.Header title="Cảnh báo xuất quá số lượng tồn" />
