...
import { PrinterIcon } from "@erp/pos/components/icons/Icon";
...
export interface VietQrPaymentDialogProps {
  open: boolean;
  onClose: () => void;
...
/**
 * VietQR payment modal — opened from `QrPaymentButton`. Re-uses `AppDialog`
