...
import { ReturnInvoiceColumnKey } from "../constants/returnGoods";
import { sumInvoiceTotals } from "../lib/returnGoodsMath";
import type { ReturnInvoiceFilters, ReturnInvoiceRow } from "../types";
 ...
 * `<DataTable />` with column defs, per-column filter cells and a
...
export function ReturnInvoiceTable({
  ...
  const columns = useMemo<ReadonlyArray<DataTableColumn<ReturnInvoiceRow>>>(
    () => [
      {
