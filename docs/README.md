...
- [Partner Order API](./partner-order-api.md) — third-party order intake: `POST /v2/partner/orders`, payload/response, errors, and the backoffice/POS steps that follow
