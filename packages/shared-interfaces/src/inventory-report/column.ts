...
/**
 * Status values of the temp-warehouse-out report's `status` select filter, and
 * the single place they are declared — the backoffice pages import from here
 * rather than listing their own copies.
 *
